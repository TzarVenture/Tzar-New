    ...
    <section className="bg-[#EFE8E0] pb-20 pt-4 relative z-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white/40 backdrop-blur-md border border-[#1D4224]/10 rounded-3xl p-6 sm:p-10 shadow-sm transition-all duration-500">
          ...
          {/* Search Engine Optimization (Always Visible) */}
          ...
          {/* Collapsible Content Trigger Block */}
          {!isExpanded ? (
            <div className="pt-2">
              <p className="font-inter text-sm sm:text-base text-[#5C6860] leading-relaxed inline">
              ...
              <button 
                ...
                className="inline-flex items-center gap-1 text-[#1D4224] hover:text-[#FFAE00] font-mono text-xs sm:text-sm font-bold uppercase tracking-wider ml-2 transition-colors duration-300 outline-none"
              >
            ...
            <div className="transition-all duration-500 ease-in-out">
              ...
              <button 
                ...
                className="inline-flex items-center gap-1 text-[#1D4224] hover:text-[#FFAE00] font-mono text-xs sm:text-sm font-bold uppercase tracking-wider transition-colors duration-300 outline-none mt-2"
              >
